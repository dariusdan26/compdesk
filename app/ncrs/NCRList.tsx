    ...
    <div>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.75rem', gap: '0.75rem', flexWrap: 'wrap' }}>
        <div>
          ...
          <p style={{ color: '#717680', fontSize: '0.875rem' }}>{ncrs.length === 0 ? 'No reports submitted yet' : `${ncrs.length} report${ncrs.length === 1 ? '' : 's'}`}</p>
        </div>
      ...
      {ncrs.length === 0 ? (
        <div style={{ textAlign: 'center', padding: '4rem 1rem', background: '#fff', borderRadius: '1rem', border: '1px solid #D4D7DC' }}>
          ...
          <p style={{ color: '#717680', fontSize: '0.9375rem', marginBottom: '0.75rem' }}>No non-conformance reports yet.</p>
          ...
          {ncrs.map(ncr => {
            ...
            return (
              ...
              >
                ...
                <p style={{ fontSize: '0.8125rem', color: '#717680', marginBottom: '0.25rem' }}>PO: <span style={{ color: '#1B3A5C', fontWeight: 600 }}>{ncr.bcPoNumber}</span> · {ncr.defectType} · {ncr.itemDescription}</p>
                ...
                <p style={{ fontSize: '0.75rem', color: '#B0B4B9', marginTop: '0.25rem' }}>by {ncr.user.name}</p>
              </button>
            )
          })}
        </div>
          ...
          <div style={{ background: '#fff', borderRadius: '1rem 1rem 0 0', boxShadow: '0 -4px 40px rgba(0,0,0,0.18)', width: '100%', maxWidth: '38rem', maxHeight: '92dvh', display: 'flex', flexDirection: 'column', border: '1px solid #D4D7DC' }}>
            ...
            <div style={{ padding: '1.5rem', overflowY: 'auto', overscrollBehavior: 'contain', flex: 1, display: 'flex', flexDirection: 'column', gap: '1.125rem' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                <div><p style={{ fontSize: '0.75rem', fontWeight: 600, color: '#717680', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.25rem' }}>BC PO Number</p><p style={{ fontSize: '0.9375rem', color: '#1B3A5C', fontWeight: 600 }}>{viewing.bcPoNumber}</p></div>
                <div><p style={{ fontSize: '0.75rem', fontWeight: 600, color: '#717680', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.25rem' }}>Defect Type</p><p style={{ fontSize: '0.9375rem', color: '#1B3A5C' }}>{viewing.defectType}</p></div>
              </div>
              <div><p style={{ fontSize: '0.75rem', fontWeight: 600, color: '#717680', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.25rem' }}>Item / Material</p><p style={{ fontSize: '0.9375rem', color: '#1B3A5C' }}>{viewing.itemDescription}</p></div>
              <div><p style={{ fontSize: '0.75rem', fontWeight: 600, color: '#717680', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.375rem' }}>Description of Non-Conformance</p><p style={{ fontSize: '0.9375rem', color: '#1B3A5C', lineHeight: 1.6 }}>{viewing.description}</p></div>
              {viewing.adminNote && (
