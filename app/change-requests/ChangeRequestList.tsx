      ...
      {requests.length === 0 ? (
        <div style={{ textAlign: 'center', padding: '4rem 1rem', background: '#fff', borderRadius: '1rem', border: '1px solid #D4D7DC' }}>
          <div style={{ width: '3.5rem', height: '3.5rem', borderRadius: '0.875rem', background: '#E0E4E9', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 1rem' }}>
            <svg width="24" height="24" fill="none" stroke="#4E7FB5" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
            </svg>
          </div>
          <p style={{ color: '#717680', fontSize: '0.9375rem', marginBottom: '0.75rem' }}>No change requests yet.</p>
          <button onClick={() => setShowForm(true)} style={{ color: '#4E7FB5', background: 'none', border: 'none', cursor: 'pointer', fontWeight: 500, fontSize: '0.875rem' }}>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  border: '1px solid #D4D7DC', cursor: 'pointer', textAlign: 'left',
              ...
              >
                <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '0.75rem', marginBottom: '0.5rem' }}>
                  ...
                  <span style={{ fontSize: '0.75rem', color: '#B0B4B9', flexShrink: 0 }}>
                ...
                <p style={{ fontSize: '0.75rem', color: '#B0B4B9', marginTop: '0.25rem' }}>by {req.user.name}
                </p>
                {req.adminNote && (
                  <p style={{ fontSize: '0.75rem', color: '#717680', marginTop: '0.375rem' }}>
        ...
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', padding: '0', zIndex: 50 }}>
          <div style={{ background: '#fff', borderRadius: '1rem 1rem 0 0', boxShadow: '0 -4px 40px rgba(0,0,0,0.18)', width: '100%', maxWidth: '38rem', maxHeight: '92dvh', display: 'flex', flexDirection: 'column', border: '1px solid #D4D7DC' }}>
            <div style={{ padding: '1.25rem 1.5rem', borderBottom: '1px solid #F0F2F5', display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '1rem', flexShrink: 0 }}>
              ...
              <button onClick={() => setViewing(null)} style={{ color: '#8A8F96', background: 'none', border: 'none', cursor: 'pointer', flexShrink: 0 }}
            ...
            <div style={{ padding: '1.5rem', overflowY: 'auto', overscrollBehavior: 'contain', flex: 1, display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              <div>
                <p style={{ fontSize: '0.75rem', fontWeight: 600, color: '#717680', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.375rem' }}>Proposed Change</p>
                <p style={{ fontSize: '0.9375rem', color: '#1B3A5C', lineHeight: 1.6 }}>{viewing.description}</p>
              </div>
              <div>
                <p style={{ fontSize: '0.75rem', fontWeight: 600, color: '#717680', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.375rem' }}>Reason</p>
              ...
              <p style={{ fontSize: '0.75rem', color: '#B0B4B9' }}>
        ...
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', padding: '0', zIndex: 50 }}>
          <div style={{ background: '#fff', borderRadius: '1rem 1rem 0 0', boxShadow: '0 -4px 40px rgba(0,0,0,0.18)', width: '100%', maxWidth: '38rem', maxHeight: '92dvh', display: 'flex', flexDirection: 'column', border: '1px solid #D4D7DC' }}>
            <div style={{ padding: '1.25rem 1.5rem', borderBottom: '1px solid #F0F2F5', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexShrink: 0 }}>
              ...
              <button onClick={() => setShowForm(false)} style={{ color: '#8A8F96', background: 'none', border: 'none', cursor: 'pointer' }}
                onMouseEnter={e => (e.currentTarget.style.color = '#1B3A5C')}
                onMouseLeave={e => (e.currentTarget.style.color = '#8A8F96')}
              >
                <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div style={{ padding: '1.5rem', overflowY: 'auto', overscrollBehavior: 'contain', flex: 1, display: 'flex', flexDirection: 'column', gap: '1.125rem' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                ...
                <div>
                  <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: 600, color: '#4E7FB5', marginBottom: '0.375rem' }}>Urgency</label>
                  <select
                    value={form.urgency}
              ...
              <div>
                <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: 600, color: '#4E7FB5', marginBottom: '0.375rem' }}>Proposed Change</label>
                <textarea
                  value={form.description}
                  onChange={e => setForm(f => ({ ...f, description: e.target.value }))}
                  placeholder="Describe the change you are proposing..."
                  rows={4}
                  style={{ width: '100%', padding: '0.5rem 0.75rem', borderRadius: '0.5rem', border: '1px solid #C8CDD3', color: '#1B3A5C', fontSize: '0.875rem', resize: 'vertical', fontFamily: 'inherit' }}
                />
              </div>
              <div>
                <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: 600, color: '#4E7FB5', marginBottom: '0.375rem' }}>Reason</label>
                <textarea
                  value={form.reason}
            ...
            <div style={{ padding: '1rem 1.5rem', borderTop: '1px solid #F0F2F5', display: 'flex', justifyContent: 'flex-end', gap: '0.625rem', flexShrink: 0 }}>
              ...
              <button
                ...
                disabled={submitting}
                style={{ padding: '0.5rem 1.25rem', fontSize: '0.875rem', fontWeight: 600, background: '#4E7FB5', color: '#fff', border: 'none', borderRadius: '0.5rem', cursor: 'pointer', opacity: submitting ? 0.6 : 1 }}
                onMouseEnter={e => { if (!submitting) (e.currentTarget as HTMLButtonElement).style.background = '#3A6A9A' }}
                onMouseLeave={e => (e.currentTarget.style.background = '#4E7FB5')}
              >
