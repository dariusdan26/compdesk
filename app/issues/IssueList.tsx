...
const STATUS_STYLES: Record<string, { bg: string; color: string; label: string }> = {
  ...
  closed:       { bg: '#F2F3F5', color: '#475569', label: 'Closed' },
}
    ...
    <div>
      ...
      {issues.length === 0 ? (
        <div style={{ textAlign: 'center', padding: '4rem 1rem', background: '#fff', borderRadius: '1rem', border: '1px solid #D4D7DC' }}>
          ...
          <p style={{ color: '#717680', fontSize: '0.9375rem', marginBottom: '0.75rem' }}>No issues reported yet.</p>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  border: `1px solid ${issue.status === 'open' || issue.urgency === 'Critical' ? '#FECACA' : '#D4D7DC'}`,
                ...
                onMouseLeave={e => {
                  ...
                  ;(e.currentTarget as HTMLButtonElement).style.borderColor = issue.status === 'open' || issue.urgency === 'Critical' ? '#FECACA' : '#D4D7DC'
                }}
              >
                ...
                <p style={{ fontSize: '0.75rem', color: '#B0B4B9', marginTop: '0.25rem' }}>by {issue.user.name}</p>
                {issue.resolution && (
      ...
      {viewing && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', padding: '0', zIndex: 50 }}>
          <div style={{ background: '#fff', borderRadius: '1rem', boxShadow: '0 20px 60px rgba(0,0,0,0.2)', width: '100%', maxWidth: '40rem', maxHeight: '88vh', display: 'flex', flexDirection: 'column', border: '1px solid #D4D7DC' }}>
            ...
            <div style={{ padding: '1.5rem', overflowY: 'auto', overscrollBehavior: 'contain', flex: 1, display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              <div>
                <p style={{ fontSize: '0.75rem', fontWeight: 600, color: '#717680', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.375rem' }}>Issue Description</p>
              ...
              {viewing.resolution && (
                <div style={{ padding: '0.875rem 1rem', borderRadius: '0.625rem', background: '#F2F3F5', border: '1px solid #D4D7DC' }}>
                  <p style={{ fontSize: '0.75rem', fontWeight: 600, color: '#717680', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.375rem' }}>Resolution</p>
        ...
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', padding: '0', zIndex: 50 }}>
          <div style={{ background: '#fff', borderRadius: '1rem 1rem 0 0', boxShadow: '0 -4px 40px rgba(0,0,0,0.18)', width: '100%', maxWidth: '38rem', maxHeight: '92dvh', display: 'flex', flexDirection: 'column', border: '1px solid #D4D7DC' }}>
            ...
            <div style={{ padding: '1.5rem', overflowY: 'auto', overscrollBehavior: 'contain', flex: 1, display: 'flex', flexDirection: 'column', gap: '1.125rem' }}>
              ...
              <div>
                <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: 600, color: '#4E7FB5', marginBottom: '0.375rem' }}>Issue Description</label>
                <textarea
