        ...
        {docs.length === 0 ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            {filtered.map(doc => {
              ...
              return (
                <div key={doc.id} style={{ background: '#fff', borderRadius: '0.875rem', padding: '0.875rem 1.125rem', border: '1px solid #D4D7DC', display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', flexShrink: 0 }}>
                    <a href={doc.filePath} target="_blank" rel="noopener noreferrer" style={{ fontSize: '0.8125rem', fontWeight: 500, color: '#4E7FB5', textDecoration: 'none' }}
                      onMouseEnter={e => (e.currentTarget.style.color = '#1B3A5C')}
                      onMouseLeave={e => (e.currentTarget.style.color = '#4E7FB5')}
                    >View</a>
                    <button onClick={() => openEdit(doc)} style={{ fontSize: '0.8125rem', fontWeight: 500, color: '#717680', background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}
                      onMouseEnter={e => (e.currentTarget.style.color = '#1B3A5C')}
